...
public class PrikazKdedcera implements IPrikaz {
     ...
     */
    public PrikazKdedcera(HerniPlan plan, SeznamOsob seznamOsob, Hra hra, Inventar inventar, SeznamPredmetu seznamPredmetu) {
        this.plan = plan;
    ...
    public String provedPrikaz(String... parametry) {
        ...
        if (plan.getAktualniProstor().getNazev().equals("hospoda") && promena.equals("Pistolník_Diego_Sanchez")) {
            if (seznamOsob.najdiOsobu(promena).getPopis().equals("- zadal nám úkol") && inventar.najdi("puška").equals(true)) {
                ...
                seznamPredmetu.najdiPredmet("klíč_k_diegovu_domu").setLzeZvednout(true);
                seznamPredmetu.najdiPredmet("klíč_k_diegovu_domu").setSebrano(true);
                inventar.vloz("klíč_k_diegovu_domu");
